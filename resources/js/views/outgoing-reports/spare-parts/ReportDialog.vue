...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            this.$store.dispatch(`outgoingSparePartReport/${this.mode}Report`, {
    ...
    computed: {
        errors() {
            return this.$store.getters['outgoingSparePartReport/getErrors'];
        },
        saving() {
            return this.$store.getters['outgoingSparePartReport/isSaving'];
        }
    },
    watch: {
        value(val) {
