        ...
        @if($data == null)
            ...
            <div class="card">
                ...
                <div class="text-center p-2">
                    @include('printer/_series', ['code' => $partNumber])
                </div>
            </div>
            <a class="m-2 btn btn-block btn-info" href="/web/spart-parts/{{$partNumber}}/add-profile">Add profile</a>
        @else
            <h5>Finished good</h5>
            <hr class="mt-0 mb-3">
            <dl class="row">
            ...
            <div class="text-center">
                <a href="/web/spare-parts/{{$partNumber}}/add-profile" class="btn btn-sm btn-info">edit</a>
            </div>
        @endif
    </div>
