...
class OutgoingFinishedGoodReportItemsController extends Controller
{
    public function index($reportId) {
        $result = FinishedGoodItem::with('finishedGood')->whereHas('outgoingFinishedGoodReports', function($query) use ($reportId) {
